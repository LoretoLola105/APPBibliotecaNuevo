...
//        jTgenero.setText(String.valueOf(jTable1.getValueAt(seleccion, 4)));
    ...
    private void armarCabeceraTabla() {
        ...
        // Aplica el renderer personalizado a la columna "Titulo"
        int columnaTitulo = 1;
    ...
    private void cargarDatosPrestados() {
        //borrarFilasTabla();
        Prestamo selec = (Prestamo) jComboBox2.getSelectedItem();
        List<Ejemplar> lista = (ArrayList) presData.obtenerLibrosPrestados(selec.getIdPrestamo());
        for (Ejemplar ejemplar : lista) {
            modelo.addRow(new Object[]{ejemplar.getIdEjemplar(), ejemplar.getIdIsbnInt(), ejemplar.getEstado(), ejemplar.isActivo()});
            System.out.println(ejemplar.getIdIsbn().getTitulo());
        }
    }
